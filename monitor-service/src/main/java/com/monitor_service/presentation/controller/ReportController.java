...
public class ReportController {
	...
	public CommonResponse<Long> deleteReport(@PathVariable Long reportId) {
		Long deletedId = reportService.deleteReport(reportId);

		return CommonResponse.of(SuccessCode.DELETED, deletedId);
	}
}
